...
export default function ProfileScreen(props) {
	...
	const isValidNewPassword = (passwordVal) =>
		isValidPassword(passwordVal) && oldPassword !== passwordVal;
			...
			<KeyboardAwareScrollView
				...
				<View
					...
					<TextInput
						...
						style={[
							renderFormFieldStyle(isValidNewPassword(newPassword)),
							styles.newPassword
						]}
						value={newPassword}
						onChangeText={(val) => {
