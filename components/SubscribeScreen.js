...
export default function SubscribeScreen(props) {
    ...
    return (
        <><ScrollView style={[ 
            ...
            contentContainerStyle={{ flex: 1, alignItems: 'center', justifyContent: 'flex-start' }} enableOnAndroid={true}
            ...
            <Pressable
                ...
                style={hasValidInput 
                        ...
                        : { ...styles.button, ...styles.subscribeButton, ...styles.disabledButton }}
                onPress={_ => { subscribeToNewsletter(); }
            }>
